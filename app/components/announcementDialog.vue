<template>
    <Dialog>
        ...
        <DialogContent class="sm:max-w-md border-accent">
            <DialogHeader>
                <DialogTitle>Make an announcement!</DialogTitle>
            </DialogHeader>
            <div className="flex flex-col items-end space-x-2 gap-2">
                <Textarea
                    v-model:model-value="announcementData"
                    placeholder="Our bot has been experiencing an unexpected hurdle..."
                />
            ...
            <DialogFooter>
                <Button v-if="!String(announcementData).length" disabled
                    >Submit</Button
                >
                <DialogClose v-else>
                    <Button type="submit" @click="submitAnnouncement"
                        >Submit</Button
                    >
                </DialogClose>
            </DialogFooter>
